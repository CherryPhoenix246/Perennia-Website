      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 bottom-0 w-full max-w-md bg-[#0F0F0F] z-50 flex flex-col"
          >
            {/* Header */}
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  ...
                  <p className="text-[#A3A3A3] text-sm">Your cart is empty</p>
                  <Button
                    onClick={() => setIsOpen(false)}
                      ...
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center mt-3 space-x-3">
                            ...
                            <span className="text-sm text-white w-8 text-center">{quantity}</span>
                            <button
                              onClick={() => updateQuantity(product.id, quantity + 1)}
                              className="quantity-btn"
            ...
            {items.length > 0 && (
              <div className="p-6 border-t border-white/5 space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-[#A3A3A3] uppercase tracking-widest">Total</span>
